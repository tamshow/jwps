...
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios__ = __webpack_require__(7);
...
module.exports = {
  ...
  methods: {
    ...
    buildAjax: function () {
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(this.url).then(__WEBPACK_IMPORTED_MODULE_1_lodash___default.a.bind(function (response) {
        ...
        //id順にソート
        __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.forEach(response.data, function (item, i) {
          arrSort.push(item);
        });
        ...
        //データ作成
        __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.forEach(arrSort, function (item, i) {
...
module.exports = {
  ...
  methods: {
    buildAjax: function () {
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(this.url).then(__WEBPACK_IMPORTED_MODULE_1_lodash___default.a.bind(function (response) {
        let arr = [];
        __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.forEach(response.data, function (elem) {
          arr.push(elem);
        });
        this.results = arr;
      }, this)).catch(function (error) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_16d102d6_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_CalendarList_vue__ = __webpack_require__(50);
var disposed = false
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_CalendarList_vue__["default"],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_56df5cac_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_NewsList_vue__ = __webpack_require__(51);
var disposed = false
var normalizeComponent = __webpack_require__(15)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_NewsList_vue__["default"],
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(4), __webpack_require__(2), __webpack_require__(49).setImmediate))
...
var _CalendarList = __webpack_require__(25);

var _CalendarList2 = _interopRequireDefault(_CalendarList);

var _NewsList = __webpack_require__(26);
...
document.addEventListener("DOMContentLoaded", function (e) {
  ...
  new _vue2.default({
    el: '#vue-body',
    components: {
      'calendar-list': _CalendarList2.default,
...
var render = function() {
  ...
  return _c("div", { staticClass: "calendar" }, [
    _c("div", { staticClass: "calendar__controll" }, [
      ...
      _vm._v(" "),
      _c("div", { staticClass: "calendar__now" }, [
        _vm._v(
          _vm._s(_vm.caldata.dYear) +
            "年" +
            _vm._s(_vm.caldata.dMonth + 1) +
            "月"
        )
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "calendar__next", on: { click: _vm.next } }, [
        _vm._v(">")
      ])
    ]),
    _vm._v(" "),
    _c(
      ...
      [
        _vm._l(_vm.caldata.weeklist, function(date) {
          return _c("div", { staticClass: "calendar__week" }, [
            _vm._v(_vm._s(date))
          ])
        }),
        _vm._v(" "),
        _vm._l(_vm.calevents, function(date) {
          return _c("div", [
            _c(
              "p",
              ...
              [
                _vm._v("\n        " + _vm._s(date.day)),
                _c("br"),
                _vm._v(_vm._s(date.state)),
                _c("br"),
                _vm._v(" "),
                _vm._l(_vm.listevents[date.date], function(event) {
                  return _c("span", [
                    _vm._v("\n        " + _vm._s(event.title)),
                    _c("br")
                  ])
