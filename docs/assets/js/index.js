  ...
  _createClass(Accordion, [{
    ...
    value: function handleEvents() {
      ...
      this.$selectorAC.on('click E_ENTER_KYE_CODE', function (e) {
        ...
        var isMobile = window.matchMedia('(max-width:' + _this.spWidth + ')').matches || false;
        var isTablet = window.matchMedia('(min-width:' + _this.spWidth + ') and (max-width:' + _this.tabWidth + ')').matches || false;
    ...
    value: function toggle(e) {
      ...
      if ($containerAC.hasClass('is-active')) {
        ...
        (0, _jquery2.default)('html,body').animate({ scrollTop: offsetTop - (0, _jquery2.default)('header').height() }, {
          duration: 500,
          easing: 'swing'
        });
      }
...
var AllCheck = function () {
  ...
  _createClass(AllCheck, [{
    key: 'initialize',
    value: function initialize() {
      var $trigger = (0, _jquery2.default)(this.trigger);
...
var OpenNav = function () {
  ...
  _createClass(OpenNav, [{
    ...
    value: function handleEvents() {
      ...
      var $bodyContents = (0, _jquery2.default)(this.bodyContents);
      var $bgSelector = (0, _jquery2.default)(this.bgSelector);
      var $lowerLayerSelector = (0, _jquery2.default)(this.lowerLayerSelector);
      var $focusSelector = (0, _jquery2.default)(this.focusSelector);

      $selector.on('click', function (e) {

        _this.toggle(e, $selector, $bodyContents, $bgSelector, $lowerLayerSelector, _this.iconOpen, _this.iconClose, $focusSelector);
      });

      $bgSelector.on('click', function (e) {
        _this.settingInitialization($selector, $bodyContents, $bgSelector, $lowerLayerSelector, _this.iconOpen, _this.iconClose, $focusSelector);
      });
    }
  }, {
    key: 'toggle',
  ...
  _createClass(Pagescroll, [{
    ...
    value: function scroll(e) {
      ...
      if (targetHref.includes('#')) {
        ...
        var offset = (0, _jquery2.default)(targetHref).offset() || {};
        var offsetTop = offset.top || 0;
...
var _pagescroll = __webpack_require__(22);

var _pagescroll2 = _interopRequireDefault(_pagescroll);

var _opennav = __webpack_require__(21);

var _opennav2 = _interopRequireDefault(_opennav);

var _allcheck = __webpack_require__(18);
