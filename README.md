...
Japan Web Production Standardsは統一ルールに基づいたCSSとJavaScriptのUIデザインパーツとwebサイト用のビジュアルスタイルのガイドが含まれています。
UIコンポーネントを組み合わせてwebページを構築していく手法を得意としCMSを構築しやすい形にまとめています。   
