...
module.exports = {
  ...
  methods: {
    ...
    buildAjax: function buildAjax() {
      _axios2.default.get(this.url).then(_lodash2.default.bind(function (response) {
        ...
        //id順にソート
        _lodash2.default.forEach(response.data, function (item, i) {
          arrSort.push(item);
        });
        ...
        //データ作成
        _lodash2.default.forEach(arrSort, function (item, i) {
          if (arrNum.indexOf(item.date) >= 0) {
            ...
            arr[item.date] = _defineProperty({}, item.id, {
              'date': item.date,
              'title': item.title,
              'url': item.url
            });
...
module.exports = {
  ...
  methods: {
    buildAjax: function buildAjax() {
      _axios2.default.get(this.url).then(_lodash2.default.bind(function (response) {
        var arr = [];
        _lodash2.default.forEach(response.data, function (elem) {
          arr.push(elem);
        });
        this.results = arr;
      }, this)).catch(function (error) {
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(4), __webpack_require__(2), __webpack_require__(48).setImmediate))
...
var _CalendarList = __webpack_require__(24);

var _CalendarList2 = _interopRequireDefault(_CalendarList);

var _NewsList = __webpack_require__(25);
