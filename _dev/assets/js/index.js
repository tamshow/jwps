...
var Accordion = function () {
  function Accordion(opts) {
    ...
    this.conf = _jquery2.default.extend({}, defaults, opts);
    this.initialize();
  }
  ...
  _createClass(Accordion, [{
    ...
    value: function initialize() {
      this.$selectorAC = (0, _jquery2.default)('[data-toggle-accordion]');
      this.containerAC = '[data-accordion]';
      this.deviceAC = '[data-device-accordion]'; //all, pc, tab, sp
      this.bodyAC = '[data-body-accordion]';
      _jquery2.default.Event('E_ENTER_KYE_CODE', { keyCode: 13, which: 13 });
    ...
    value: function handleEvents() {
      ...
      this.$selectorAC.on('click E_ENTER_KYE_CODE', function (e) {
        var media = (0, _jquery2.default)(e.currentTarget).parents(_this.deviceAC).data('device-accordion') || 'all';
    ...
    value: function toggle(e) {
      ...
      if ($containerAC.hasClass('is-active')) {
        ...
        (0, _jquery2.default)('html,body').animate({ scrollTop: $target.offset().top - (0, _jquery2.default)('header').height() }, {
          duration: 500,
          easing: 'swing'
        });
      }
...
var Modal = function () {
  ...
  _createClass(Modal, [{
    ...
    value: function initialize() {
      ...
      this.$modalSelector = (0, _jquery2.default)('[data-modal]');
      this.$openModalSelector = (0, _jquery2.default)('[data-open-modal]');
      this.$closeModalSelector = (0, _jquery2.default)('[data-close-modal]');
      this.$appendSelector = (0, _jquery2.default)('[data-append-modal]');

      if ((0, _jquery2.default)(this.$modalSelector).length) {

        this.$areaHidden = (0, _jquery2.default)('header, footer, main');
        this.currentScrollY = null;

        (0, _jquery2.default)('body').append('<div class="c-modal-dialog-bg" data-close-modal aria-expanded="true" aria-label="閉じる"></div>');
        this.$modalBg = (0, _jquery2.default)('.c-modal-dialog-bg');
        this.$modalBg.css({
          display: 'none',
          width: '100%',
          height: '100%',
    ...
    value: function show(e) {
      ...
      var $clone = (0, _jquery2.default)('[data-clone-modal="' + containerAttr + '"]');
    ...
    value: function hide(e) {
      ...
      (0, _jquery2.default)('html, body').prop({ scrollTop: this.currentScrollY });
...
var OpenNav = function () {
  ...
  _createClass(OpenNav, [{
    ...
    value: function handleEvents() {
      ...
      var _conf = this.conf,
          container = _conf.container,
          selector = _conf.selector,
          bodyContents = _conf.bodyContents,
          bgSelector = _conf.bgSelector,
          lowerLayerSelector = _conf.lowerLayerSelector,
          iconOpen = _conf.iconOpen,
          iconClose = _conf.iconClose,
          focusSelector = _conf.focusSelector;


      var $container = (0, _jquery2.default)(container);
      var $selector = (0, _jquery2.default)(selector);
      var $bodyContents = (0, _jquery2.default)(bodyContents);
      var $bgSelector = (0, _jquery2.default)(bgSelector);
      var $lowerLayerSelector = (0, _jquery2.default)(lowerLayerSelector);
      var $focusSelector = (0, _jquery2.default)(focusSelector);

      $selector.on('click', function (e) {

        _this.toggle(e, $selector, $bodyContents, $bgSelector, $lowerLayerSelector, iconOpen, iconClose, $focusSelector);
      });

      $bgSelector.on('click', function (e) {
        _this.settingInitialization($selector, $bodyContents, $bgSelector, $lowerLayerSelector, iconOpen, iconClose, $focusSelector);
      });
    }
  }, {
    key: 'toggle',
    value: function toggle(e, $selector, $bodyContents, $bgSelector, $lowerLayerSelector, iconOpen, iconClose, $focusSelector) {
      ...
      if ($bodyContents.attr('aria-hidden') === 'true') {
        ...
        (0, _jquery2.default)('input').first().focus();
        //メニューアイコン
    ...
    value: function settingInitialization($selector, $bodyContents, $bgSelector, $lowerLayerSelector, iconOpen, $focusSelector) {
...
var Pagescroll = function () {
  ...
  _createClass(Pagescroll, [{
    ...
    value: function initialize() {
      ...
      this.$scrollTotop = (0, _jquery2.default)('[data-scroll="to-top"]');
      this.mainH = (0, _jquery2.default)('header').height();
    ...
    value: function handleEvents() {
      ...
      (0, _jquery2.default)(document).on('click', this.scrollSelector + ' a', function (e) {
        _this.scroll(e);
      });
    ...
    value: function scroll(e) {
      ...
      if (targetHref.includes('#')) {
        $target.blur();
        (0, _jquery2.default)('html,body').animate({ scrollTop: (0, _jquery2.default)(targetHref).offset().top }, {
...
var Ripple = function () {
  ...
  _createClass(Ripple, [{
    ...
    value: function handleEvents() {
      ...
      _lodash2.default.each(this.ripples, function (elem) {
        _this.rippleButton(elem);
      });
    }
  }, {
    key: 'rippleButton',
    value: function rippleButton(btn) {
...
var Tabs = function () {
  ...
  _createClass(Tabs, [{
    ...
    value: function panelSelect($target) {
      ...
      (0, _jquery2.default)('#' + panel).attr('aria-hidden', 'false').siblings(this.tabPanelSelector).attr('aria-hidden', 'true');
    }
  }, {
    key: 'handleEvents',
    value: function handleEvents() {
      ...
      (0, _jquery2.default)(this.tabListSelector).on('click', function (e) {
        e.preventDefault();
        var $target = (0, _jquery2.default)(e.currentTarget);
        _this.listSelect($target);
        _this.panelSelect($target);
      });
    ...
    value: function tabKeyup(e) {
      ...
      switch (e.keyCode) {
        ...
        case leftArrow:
          $target = (0, _jquery2.default)(e.target).prev().children(this.tabListSelector);
          break;

        case rightArrow:

          $target = (0, _jquery2.default)(e.target).next().children(this.tabListSelector);
          break;
...
var _pagescroll = __webpack_require__(21);

var _pagescroll2 = _interopRequireDefault(_pagescroll);

var _opennav = __webpack_require__(20);

var _opennav2 = _interopRequireDefault(_opennav);

var _allcheck = __webpack_require__(17);
...
document.addEventListener("DOMContentLoaded", function (e) {
  ...
  var repple = new _ripple2.default();

  var navSp = new _opennav2.default();
  var searchSp = new _opennav2.default({
  ...
  var allCheck = new _allcheck2.default({
    trigger: '[data-allcheck="trigger"]',
    container: '[data-allcheck="container"]'
  });
});
